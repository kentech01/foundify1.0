      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {plans.map((plan) => {
            ...
            const billedAmount = billingCycle === 'annually' && plan.id === 'premium' 
              ? 'Billed as $120/year' 
              : null;
            ...
            return (
              ...
              >
                ...
                <CardHeader className={`p-8 ${
                  plan.highlighted ? 'bg-gradient-to-br from-premium-purple-50 to-white' : 'bg-white'
                }`}>
                    ...
                    {plan.features.map((feature, index) => (
                      <li key={index} className="flex items-start">
                        <Check className={`h-5 w-5 mr-3 mt-0.5 flex-shrink-0 ${
                          plan.highlighted ? 'text-premium-purple' : 'text-deep-blue'
                        }`} />
