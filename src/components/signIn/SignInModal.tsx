          ...
          {!isLogin ? (
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full border-gray-200 hover:bg-blue-50 hover:border-blue-200 cursor-pointer"
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-deep-blue cursor-pointer hover:bg-deep-blue-dark text-white"
                disabled={isLoading}
              >
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full border-gray-200 cursor-pointer hover:bg-blue-50 hover:border-blue-200"
                onClick={handleGoogleSignIn}
                disabled={isLoading}
              >
                <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
