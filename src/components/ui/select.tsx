...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // Layout & sizing aligned with text inputs
        "flex w-full items-center justify-between gap-2 rounded-lg border px-4 py-2.5 text-sm whitespace-nowrap",
        "data-[size=default]:h-11 data-[size=sm]:h-9",
        // Background / border to match design (#f7f7f7 background, #e5e5e5 border)
        "bg-[#f7f7f7] border-[#e5e5e5] dark:bg-input/30 dark:border-input dark:hover:bg-input/50",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          // Match trigger background & border for a seamless dropdown
          "bg-[#f7f7f7] text-popover-foreground relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-lg border border-[#e5e5e5] shadow-lg",
          // Animations
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        // Soft hover to mimic design
        "hover:bg-[#f0f0f0] focus:bg-[#f0f0f0] focus:text-foreground",
